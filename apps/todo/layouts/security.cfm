	...
	<cfoutput>
		...
		<ul class="m-siteNavigation">
			<li class="navItem <cfif (request.viewData.activeNavItem eq "signIn")>activeNavItem</cfif>">
				<a href="./index.cfm?cfm=security.login">Sign In</a>
			</li>
			<li class="navItem <cfif (request.viewData.activeNavItem eq "createAccount")>activeNavItem</cfif>">
				<a href="./index.cfm?cfm=security.createAccount">Create Account</a>
			</li>
			<li class="navItem <cfif (request.viewData.activeNavItem eq "signIn")>activeNavItem</cfif>">
				<a href="./index.cfm?cfc=security.login">Sign In</a>
			</li>
			<li class="navItem <cfif (request.viewData.activeNavItem eq "createAccount")>activeNavItem</cfif>">
				<a href="./index.cfm?cfc=security.createAccount">Create Account</a>
			</li>
		</ul>
